...
This is a web interface that applies a variety of image effects, created from the php GD functions, and applied to a set of 
...
Future improvements:
       ...
       - A module to allow uploading your own jpeg files, of course there are security and size concerns, such as the size of jpeg file, but since this is just a personal project for now, uploading to local folder is good enough, no need for blob type in database
